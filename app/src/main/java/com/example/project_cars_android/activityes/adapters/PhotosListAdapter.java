...
public class PhotosListAdapter extends RecyclerView.Adapter<PhotosListAdapter.PhotosListViewHolder> {
    ...
    @NonNull
    @Override
    public PhotosListAdapter.PhotosListViewHolder onCreateViewHolder(@NonNull final ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final PhotosListAdapter.PhotosListViewHolder photosListViewHolder, final int i) {
